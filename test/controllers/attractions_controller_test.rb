...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { description: @attraction.description, images: @attraction.images, location: @attraction.location, name: @attraction.name } }, as: :json
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { description: @attraction.description, images: @attraction.images, location: @attraction.location, name: @attraction.name } }, as: :json
    assert_response 200
  end
